...
define("_YES","Бno");
define("_NO","Nie");
define("_REQUIRED","(povinnй)");
define("_SAVECHANGES","Uloћi? zmeny");
define("_OK","Ok!");
define("_HELLO","Ahoj,");
define("_ICQ","ICQ инslo");
define("_AIM","AIM инslo");
define("_YIM","YIM инslo");
define("_MSNM","MSNM инslo");
define("_LOCATION","bydlisko");
define("_OCCUPATION","zamestnanie");
define("_INTERESTS","zбujmy");
define("_SIGNATURE","Podpis");
define("_OPTION","Nastavenie");
define("_NAME","Meno");
define("_USERS","uћнvatelia");
define("_RETYPEPASSWD","Zopakujte heslo");
define("_FORCHANGES","(iba pre zmeny)");
define("_YEAR","Rok");
define("_USERADMIN","Administrбcia uћнvateѕov");
define("_EDITUSER","Upravi? uћнvateѕa");
define("_MODIFY","Zmeni?");
define("_ADDUSER","Prida? novйho uћнvateѕa");
define("_FAKEEMAIL","Nepravб e-mailovб adresa");
define("_ALLOWUSERS","Umoћni? ostatnэm uћнvateѕom vidie? moju e-mailovъ adresu");
define("_ADDUSERBUT","Prida? uћнvateѕa");
define("_USERUPDATE","Zmeni? uћнvateѕa");
define("_USERID","uћнvateѕ ID");
define("_USERNOEXIST","Tento uћнvateѕ neexistuje!");
define("_PASSWDNOMATCH","Novй heslo ћiaѕ nebolo nбjdenй. Vrб?te sa spд? a skъs to znova");
define("_DELETEUSER","Vymaza? uћнvateѕa");
define("_SURE2DELETE","Ste si istэ, ћe chcete zruљi? uћнvateѕa");
define("_NEEDTOCOMPLETE","Musнte doplni? vљetky vyћadovanй poloћky");
define("_TEAM","tнm.");
