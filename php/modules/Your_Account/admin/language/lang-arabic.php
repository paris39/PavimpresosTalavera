...
define("_URL","—«»Ў");
define("_EMAIL","»—нѕ «бя —ждн");
define("_YES","дЏг");
define("_NO","б«");
define("_REQUIRED","(гЎбж»)");
define("_SAVECHANGES","ЌЁў «б џнн—« ");
define("_OK","гж«Ёё!");
define("_HELLO","г—Ќ»«");
define("_ICQ","—ёг «б√н ”н янж");
define("_AIM","—ёг √г—ня« «жд б«нд");
define("_YIM","—ёг н«еж г«”дћ—");
define("_MSNM","—ёг еж гнб г«”дћ—");
define("_LOCATION","«бѕжб…");
define("_OCCUPATION","«бжўнЁ…");
define("_INTERESTS","«беж«н« ");
define("_SIGNATURE","«б жёнЏ");
define("_OPTION","≈ќ н«—");
define("_NAME","«с”г");
define("_USERS","«б√Џ÷«Ѕ");
define("_RETYPEPASSWD","√Џѕ я «»… ябг… «б”—");
define("_FORCHANGES","(бб џнн— ЁёЎ)");
define("_YEAR","«б”д…");
define("_USERADMIN","«б Ќяг Ён «б√Џ÷«Ѕ");
define("_EDITUSER"," Џѕнб Џ÷ж");
define("_MODIFY"," Џѕнб");
define("_ADDUSER","«÷«Ё… Џ÷ж ћѕнѕ");
define("_FAKEEMAIL","«б»—нѕ «б≈бя —ждн џн— «бЌёнён");
define("_ALLOWUSERS"," гянд «б√ќ—нд гд —ƒн… »—нѕн");
define("_ADDUSERBUT","√÷Ё Џ÷ж");
define("_USERUPDATE"," ЌѕнЋ гбЁ «бЏ÷ж");
define("_USERID","—ёг «бЏ÷ж");
define("_USERNOEXIST","е–« «бЏ÷ж џн— гжћжѕ!");
define("_PASSWDNOMATCH","ЏЁж« ябг… «б”— «бћѕнѕ… џн— г Ў«»ё…. «÷џЎ “— «бЏжѕ… жЌ«жб г—… «ќ—м");
define("_DELETEUSER","Ќ–Ё Џ÷ж");
define("_SURE2DELETE","еб  —нѕ Ќ–Ё «бЏ÷ж »«б √янѕњ");
define("_NEEDTOCOMPLETE"," Ќ «ћ «бм ≈яг«б ћгнЏ «бћёжб");
define("_TEAM","Ё—нё «бЏгб.");
define("_NEWSLETTER","ё«∆г… «бг—«”б…");
