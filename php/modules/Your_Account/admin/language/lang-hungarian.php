...
define("_YES","Igen");
define("_NO","Nem");
define("_REQUIRED","(Kцtelezх)");
define("_SAVECHANGES","Vбltozбsok mentйse");
define("_OK","Ok!");
define("_HELLO","Hellу,");
define("_ICQ","ICQ szбm (ha van)");
define("_AIM","AIM szбm (ha van)");
define("_YIM","YIM szбm (ha van)");
define("_MSNM","MSNM szбm (ha van)");
define("_LOCATION","Lakуhely");
define("_OCCUPATION","Foglalkozбs");
define("_INTERESTS","Йrdeklхdйsi kцrцk");
define("_SIGNATURE","Alбнrбs");
define("_OPTION","Beбllнtбsok");
define("_NAME","Nйv");
define("_USERS","Tagok");
define("_RETYPEPASSWD","Jelszу mйgegyszer");
define("_FORCHANGES","(Csak a vбltoztatбsokhoz)");
define("_YEAR","йv");
define("_USERADMIN","Tagok adminisztrбlбsa");
define("_EDITUSER","Tag szerkesztйse");
define("_MODIFY","Vбltoztatбs");
define("_ADDUSER","Ъj tag hozzбadбsa");
define("_FAKEEMAIL","Hamis e-mail cнm");
define("_ALLOWUSERS","Mбs tagok lбthatjбk az e-mail cнmem");
define("_ADDUSERBUT","Ъj tag");
define("_USERUPDATE","Javнtбs");
define("_USERID","Felhasznбlуnйv");
define("_USERNOEXIST","A tag nem lйtezik!");
define("_PASSWDNOMATCH","Sajnбlom, az ъj jelszavak nem egyformбk. Menj vissza йs prуbбld ъjra.");
define("_DELETEUSER","Tag tцrlйse");
define("_SURE2DELETE","Biztos, hogy ki akarod tцrцlni ezt a felhasznбlуt:");
define("_NEEDTOCOMPLETE","Ki kell tцltened az цsszes szьksйges mezхt!");
