...
define("_YES","Sim");
define("_NO","Nуo");
define("_REQUIRED","(necessсrio)");
define("_SAVECHANGES","Gravar alteraчѕes");
define("_OK","Ok!");
define("_HELLO","Olс");
define("_ICQ","Nњmero do ICQ");
define("_AIM","Nњmero do AIM");
define("_YIM","Nњmero do YIM");
define("_MSNM","Nњmero do MSNM");
define("_LOCATION","Localizaчуo");
define("_OCCUPATION","Profissуo");
define("_INTERESTS","Interesses");
define("_SIGNATURE","Assinatura");
define("_OPTION","Opчуo");
define("_NAME","Nome");
define("_USERS","Utilizadores");
define("_RETYPEPASSWD","Verifique Password");
define("_FORCHANGES","(Somente para alteraчѕes)");
define("_YEAR","Ano");
define("_USERADMIN","Administraчуo de Utilizadores");
define("_EDITUSER","Editar Utilizador");
define("_MODIFY","Modificar");
define("_ADDUSER","Adicionar Novo Utilizador");
define("_FAKEEMAIL","Email Secundсrio");
...
define("_USERNOEXIST","Utilizador nуo existente!");
define("_PASSWDNOMATCH","Desculpe, as novas passwords nуo coincidem. Por favor volte atrсs e tente novamente");
define("_DELETEUSER","Apagar utilizador");
define("_SURE2DELETE","Quer mesmo apagar este utilizador");
define("_NEEDTOCOMPLETE","Tem que completar todos os campos obrigatѓrios");
