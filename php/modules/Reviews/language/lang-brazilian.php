...
define("_CHECKREVIEW","Sua Revisão atual. Por favor atente-se à gramática e grafia! Escreva uma revisão com no mínimo 100 palavras. Você pode inserir código HTML em suas modificações.");
...
define("_CHECKINFO","Por favor tenha certeza que a informação que você enviou é 100% correta e está com bom gramática. Por exemplo, não exagere com seu texto, ele pode ser rejeitado.");
...
define("_INVALIDTEXT","Texto de Revisão inválido... (Você não escreveu nada!!!)");
...
define("_LOOKSRIGHT","Será que está tudo certo?!?");
...
define("_RCREATEACCOUNT","<a href=modules.php?name=Your_Account>Cadastre-se</a>");
...
define("_PAGEBREAK","Se o texto que você vai escrever é muito extenso, por favor utilize <b>[--pagebreak--]</b> para poder quebrá-lo em páginas.");
