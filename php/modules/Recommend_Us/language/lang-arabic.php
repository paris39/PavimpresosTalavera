...
define("_FFRIENDNAME","ÇÓã ÕÏíÞß:");
define("_FFRIENDEMAIL","ÈÑíÏ ÕÏíÞß:");
define("_HELLO","ãÑÍÈÇ");
define("_YOURFRIEND","ÕÏíÞß");
define("_RECOMMEND","ÇÑÓá åÐÇ ÇáãæÞÚ Çáì ÕÏíÞ");
define("_INTSITE","ãæÞÚ ããÊÚ:");
define("_OURSITE","íÚÊÞÏ Ãä ãæÞÚäÇ");
define("_INTSENT","ããÊÚ æÃÑÇÏ Ãä íÑÓáå áß.");
define("_FSITENAME","ÇÓã ÇáãæÞÚ:");
define("_FSITEURL","ÚäæÇä ÇáãæÞÚ:");
define("_FREFERENCE","ÇáãÑÌÚ áãæÞÚäÇ ÃÑÓá Çáì");
define("_THANKSREC","ÔßÑÇ áÃÎÈÇÑ ÕÏíÞß ÚäÇ!");
