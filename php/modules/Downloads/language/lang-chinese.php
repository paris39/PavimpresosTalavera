...
define("_DSUBMITONCE","請一次投遞一個下載資源");
define("_DPOSTPENDING","所有的下載資源都必須等待驗證");
...
define("_DOWNLOADSNOTUSER8","<a href=\"modules.php?name=Your_Account\">請來註冊帳號</a>");
...
define("_DTOTALFORLAST","全部最新的下載資源");
define("_DBESTRATED","最高分的下載資源");
...
define("_DLETSDECIDE","您的投票可以幫助其他使用者決定什麼是有價值的東西，節省他們自行嘗試的時間。");
define("_DRATENOTE4","瀏覽清單請至<a href=\"modules.php?name=Downloads&amp;d_op=TopRated\">高評分資源</a>.");
define("_DATE","日期");
define("_TO","到");
define("_NEW","最近的");
...
define("_BREAKDOWNBYVAL","評分數值條狀圖");
define("_LTOTALVOTES","全部投票");
define("_HIGHRATING","最高評價");
define("_LOWRATING","最低評價");
...
define("_LINKSDATESTRING","%b%d日,%Y");
