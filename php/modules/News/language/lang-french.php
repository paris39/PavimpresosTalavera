...
define("_NOANONCOMMENTS","Les commentaires anonymes ne sont pas autoris&eacute;s, veuillez vous <a href=\"modules.php?name=Your_Account\">enregistrer</a>");
...
define("_ADD","Ajouter");
define("_NOCOMMENTSACT","Désolé, les Commentaires ne sont pas autorisés pour cet article.");
define("_ARTICLEPOLL","Sondage de l'arcticle");
