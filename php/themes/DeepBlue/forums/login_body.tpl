...
<table width="100%" cellpadding="4" cellspacing="1" border="0"
	...
	<tr>
		...
		<table border="0" cellpadding="3" cellspacing="1" width="100%">
			...
			<tr align="center">
				<td colspan="2"><span class="gen">{L_AUTO_LOGIN}: <input
					type="checkbox" name="autologin" /></span></td>
			</tr>
			<tr align="center">
				<td colspan="2">{S_HIDDEN_FIELDS}<input type="submit" name="login"
					class="mainoption" value="{L_LOGIN}" /></td>
			</tr>
			<tr align="center">
