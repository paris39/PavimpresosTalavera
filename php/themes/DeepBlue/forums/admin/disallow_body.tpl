...
<table width="80%" cellspacing="1" cellpadding="4" border="0"
	...
	<tr>
		...
		<td class="row2"><input type="text" name="disallowed_user" size="30" />&nbsp;<input
			type="submit" name="add_name" value="{L_ADD}" class="mainoption" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="row2">{S_DISALLOW_SELECT}&nbsp;<input type="submit"
			name="delete_name" value="{L_DELETE}" class="liteoption" /></td>
	</tr>
	<tr>
