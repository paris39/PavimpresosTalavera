...
define("_ASREGISTERED","Ainda não é Cadastrado? Você pode se cadastrar clicando <a href=\"modules.php?name=Your_Account&amp;op=new_user\">aqui</a>. Como usuário cadastrado você tem algumas vantagens como escolher o Tema do site (template) e enviar comentários com seu nome.");
...
define("_YOUAREANON","Você é um usuário anônimo. Você pode se cadastrar gratuitamente clicando <a href=\"modules.php?name=Your_Account&amp;op=new_user\">aqui</a>.");
define("_NOTE","Nota:");
define("_ADMIN","Admin:");
...
define("_SELECTGUILANG","Selecione o idioma pra o portal:");
...
define("_MODULEUSERS", "Sentimos muito mas esa parte do nosso conteúdo é somente para <b>usuários cadastrados</b>.<br><br>Você pode se cadastrar gratuitamente clicando <a href=\"modules.php?name=Your_Account&op=new_user\">aqui</a>, e então você terá accesso<br>a esta e outras seções do nosso conteúdo sem resrições.<br><br>");
...
define("_HOMEPROBLEMUSER","Há um problema com este portal no momento. Por avor, retorne detnro de alguns instantes.");
