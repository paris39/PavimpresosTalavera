function TinyMCE_basic_getEditorTemplate() {
...
function TinyMCE_basic_execCommand(editor_id, element, command, user_interface, value) {
	switch (command) {
		case "mceCodeEditor":
			var template = new Array();

			template['file'] = 'source_editor.htm';
			template['width'] = tinyMCE.getParam("theme_basic_source_editor_width", 500);
			template['height'] = tinyMCE.getParam("theme_basic_source_editor_height", 400);
 ...
 */
function TinyMCE_basic_getInsertLinkTemplate() {
	var template = new Array();
 ...
 */
function TinyMCE_basic_getInsertImageTemplate() {
	var template = new Array();
...
function TinyMCE_basic_handleNodeChange(editor_id, node) {
	// Reset old states
